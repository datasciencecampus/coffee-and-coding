...
|:----------------:|:----:|:---:|:---------:|:--------------------:|:-------------------------------|
| Tues 17 Dec 2019 | 10:30 - 11:30 | NPT D.289 | DAPCATS RAP Demo | Wil Roberts | The Reproducible Analytical Pipeline (RAP) is a methodology for automating the bulk of the steps involved in creating a statistical report.  This beginner-to-intermediate interactive session will demonstrate some good practices in building RAP in DAP. |
